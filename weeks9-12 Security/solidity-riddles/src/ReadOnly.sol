...
contract Attack {
    function attack(address _vulnerableDeFiContract) public {
        VulnerableDeFiContract readOnly = VulnerableDeFiContract(_vulnerableDeFiContract);

        readOnly.snapshotPrice();
    }
}
